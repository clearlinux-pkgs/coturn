...
Version  : 4.5.1.3
Release  : 4
URL      : https://github.com/coturn/coturn/archive/4.5.1.3/coturn-4.5.1.3.tar.gz
Source0  : https://github.com/coturn/coturn/archive/4.5.1.3/coturn-4.5.1.3.tar.gz
...
%prep
%setup -q -n coturn-4.5.1.3
cd %{_builddir}/coturn-4.5.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594847560
...
cp %{_builddir}/coturn-4.5.1.3/LICENSE %{buildroot}/usr/share/package-licenses/coturn/44edc3a7a30e912f10454aee90d312a5d0d7fa24
cp %{_builddir}/coturn-4.5.1.3/LICENSE.OpenSSL %{buildroot}/usr/share/package-licenses/coturn/c9c50bd46b69aba62e61c65d8ab08dd1e8c83b38
%make_install
